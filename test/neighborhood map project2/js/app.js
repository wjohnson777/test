...
var ViewModel = function() {
 ...
 self.search = ko.computed(function() {
	 ...
	 if(!query) {
		 ...
		 return ko.util.arrayFilter(self.places), function(place) {
			 var quearyMatch = place.name.toLowerCase().indexOf(self.query().toLowerCase()) >= 0;
			 place.marker.setVisible(quearyMatch);
			 return quearyMatch;
		 });
	 }
 });
